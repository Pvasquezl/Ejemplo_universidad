    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (txtUsuario.getText().trim().isEmpty() || txtContraseña.getText().trim().isEmpty()) {
            ...
            try {
                ...
                usuarioAConsultar.setsNombre((txtUsuario.getText().trim()));
                // Recuperación de información a través de otro objeto
                usuarioAConsultar = usuarioDAO.query(usuarioAConsultar);

                if (txtContraseña.getText().equals(usuarioAConsultar.getsContraseña()) && txtUsuario.getText().equals(usuarioAConsultar.getsNombre())) {
